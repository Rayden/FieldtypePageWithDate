$(document).ready(function() {
	$("p.InputfieldPageWithDateAddButton a").click(function() {
		var $input = $(this).parent('p').next('.InputfieldPageWithDateAddItems');
	...
	$(".InputfieldPageWithDate .findPagesSelector").each(function() {
		...
		var $wrap = $t.parents(".InputfieldPageWithDate");
